...
exports.commands = [
    {
        ...
        execute: async (interaction, channelManager) => {
            ...
            try {
                ...
                core_1.logger.info('Channel structure synced via command', { userId: interaction.user.id });
            }
            catch (error) {
                core_1.logger.error('Failed to sync channel structure', { error, userId: interaction.user.id });
    ...
    },
    {
        data: new discord_js_1.SlashCommandBuilder()
            ...
            return option.setName('category')
                ...
                .setRequired(true)
                .addChoices({ name: 'Sneakers', value: 'sneakers' }, { name: 'GPUs', value: 'gpus' }, { name: 'Toys', value: 'toys' }, { name: 'Collectibles', value: 'collectibles' }, { name: 'Trading Cards', value: 'trading-cards' }, { name: 'Streetwear', value: 'streetwear' });
        })
        ...
        execute: async (interaction, channelManager, alertManager) => {
            ...
            try {
                ...
                await interaction.editReply(`✅ Test alert posted!\n` +
                ...
                core_1.logger.info('Test alert posted via command', {
                ...
                core_1.logger.error('Failed to post test alert', { error, userId: interaction.user.id });
    ...
    },
    {
        ...
        execute: async (interaction) => {
            ...
            core_1.logger.info('Delay updated via command', { userId: interaction.user.id, target, minutes });
        }
    },
    {
        data: new discord_js_1.SlashCommandBuilder()
    ...
    },
    {
        ...
        execute: async (interaction) => {
            ...
            core_1.logger.info('Source toggled via command', { userId: interaction.user.id, site, enabled });
        }
    }
];
